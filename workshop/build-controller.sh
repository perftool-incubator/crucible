...
if pushd ${CRUCIBLE_HOME} > /dev/null; then
    ...
    exec ./subprojects/core/workshop/workshop.py --userenv ./workshop/${controller_userenv_file} --requirements ./workshop/controller-workshop.json --label crucible-controller "$@" \
