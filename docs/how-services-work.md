...
| `list_endpoints` | List installed endpoint types, schemas, and coarse capabilities. It does not discover configured or reachable targets; callers supply target-specific endpoint configuration. |
